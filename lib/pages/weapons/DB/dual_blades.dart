import 'package:amogus/pages/weapons/DB/dummy_db.dart';
...
class DualBladesPage extends StatefulWidget {
  const DualBladesPage({super.key});

  @override
  State<DualBladesPage> createState() => _DualBladesPageState();
}

class _DualBladesPageState extends State<DualBladesPage> {
  @override
  Widget build(BuildContext context) {
    return Consumer<ThemeProvider>(
      builder: (context, themeProvider, child) {
        return Scaffold(
          appBar: customAppBar(context, 'Dual Blades Path'),
          endDrawer: rightDrawer(context),
          body: Theme(
            data: themeProvider.theme,
            child: dualBladesList(context, themeProvider),
          ),
        );
      },
    );
  ...
  Padding dualBladesList(BuildContext context, ThemeProvider themeProvider) {
    return Padding(
