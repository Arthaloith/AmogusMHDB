...
class FortressAmmoPage extends StatefulWidget {
  const FortressAmmoPage({super.key});

  @override
  State<FortressAmmoPage> createState() => _FortressAmmoPageState();
}

class _FortressAmmoPageState extends State<FortressAmmoPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: customAppBar(context, 'Fortress Ammo'),
      body: Padding(
