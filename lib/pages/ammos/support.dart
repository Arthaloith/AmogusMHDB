...
class SupportAmmoPage extends StatefulWidget {
  const SupportAmmoPage({super.key});

  @override
  State<SupportAmmoPage> createState() => _SupportAmmoPageState();
}

class _SupportAmmoPageState extends State<SupportAmmoPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: customAppBar(context, 'Support Ammo'),
      body: Padding(
