...
class AttackAmmoPage extends StatefulWidget {
  const AttackAmmoPage({super.key});

  @override
  State<AttackAmmoPage> createState() => _AttackAmmoPageState();
}

class _AttackAmmoPageState extends State<AttackAmmoPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: customAppBar(context, 'Attack Ammo'),
      body: Padding(
