...
class StatusAfflictionAmmoPage extends StatefulWidget {
  const StatusAfflictionAmmoPage({super.key});

  @override
  State<StatusAfflictionAmmoPage> createState() =>
      _StatusAfflictionAmmoPageState();
}

class _StatusAfflictionAmmoPageState extends State<StatusAfflictionAmmoPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: customAppBar(context, 'S. Affliction Ammo'),
      body: Padding(
